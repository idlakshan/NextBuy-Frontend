        ...
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-1">
            ...
            <textarea
              ...
              multiple
              rows={3}
              className="p-2 outline-none border focus-within:border-primary-200 rounded resize-none"
            />
          </div>
          <div>
            ...
            <div>
              <label
                ...
                className="h-24 border rounded flex justify-center items-center cursor-pointer"
              >
              ...
              <div className="flex flex-wrap gap-4">
                {data.image.map((img, index) => {
                  return (
                    <div
                      key={img + index}
                      className="h-20 mt-1 w-20 min-w-20 border relative group"
                    >
                      <img
                        src={img}
                        alt={img}
